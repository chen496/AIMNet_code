...
down_x<-matrix(0,num_comdit*(p-1),nrounds)
      ...
      write.table(rbind(down_x,up_x),file=paste0(dir_name,"/ss_beta_",i_lambda1,"_",j_lambda2,".csv"),sep=",",col.names = F,row.names = F)
      write.table(rbind(down_z,up_z),file=paste0(dir_name,"/ss_z_",i_lambda1,"_",j_lambda2,".csv"),sep=",",col.names = F,row.names = F)
